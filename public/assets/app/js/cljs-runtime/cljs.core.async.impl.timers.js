...
var i_14226 = (0);
while(true){
if((i_14226 < arr.length)){
(arr[i_14226] = null);

var G__14227 = (i_14226 + (1));
i_14226 = G__14227;
continue;
} else {
}
...
var i_14240 = (self__.level + (1));
while(true){
if((i_14240 <= (new_level + (1)))){
(update[i_14240] = self__.header);

var G__14242 = (i_14240 + (1));
i_14240 = G__14242;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14243 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14243[i]));
} else {
x__$2.forward.push((((i < links_14243.length))?(links_14243[i]):null));
}

if((i < links_14243.length)){
(links_14243[i] = x__$2);
} else {
links_14243.push(x__$2);
}
...
var i_14252 = (0);
while(true){
if((i_14252 <= self__.level)){
var links_14253 = (update[i_14252]).forward;
if((x__$1 === (((i_14252 < links_14253.length))?(links_14253[i_14252]):null))){
(links_14253[i_14252] = (x__$1.forward[i_14252]));

var G__14254 = (i_14252 + (1));
i_14252 = G__14254;
continue;
} else {
var G__14255 = (i_14252 + (1));
i_14252 = G__14255;
continue;
}
} else {
...
var G__14268 = nx;
var G__14269 = (level__$1 - (1));
x = G__14268;
level__$1 = G__14269;
continue;
} else {
var G__14270 = x;
var G__14271 = (level__$1 - (1));
x = G__14270;
level__$1 = G__14271;
continue;
}
