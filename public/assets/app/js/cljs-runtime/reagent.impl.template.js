...
var G__12134 = o;
reagent.impl.template.goog$module$goog$object.set(G__12134,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__12153__i < G__12153__a.length) {G__12153__a[G__12153__i] = arguments[G__12153__i + 0]; ++G__12153__i;}
  args = new cljs.core.IndexedSeq(G__12153__a,0,null);
} 
...
var G__12135 = o;
reagent.impl.template.goog$module$goog$object.set(G__12135,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12155__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12155 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12156__i = 0, G__12156__a = new Array(arguments.length -  0);
while (G__12156__i < G__12156__a.length) {G__12156__a[G__12156__i] = arguments[G__12156__i + 0]; ++G__12156__i;}
  args = new cljs.core.IndexedSeq(G__12156__a,0,null);
} 
return G__12155__delegate.call(this,args);};
G__12155.cljs$lang$maxFixedArity = 0;
G__12155.cljs$lang$applyTo = (function (arglist__12158){
var args = cljs.core.seq(arglist__12158);
return G__12155__delegate(args);
});
...
var G__12136 = props;
var G__12136__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12136,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12136);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12136__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12137 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12137,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12137;
}
})(),id_class);
...
var G__12138 = (cljs.core.count(argv) - first_child);
switch (G__12138) {
case (0):
...
var vec__12139 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12139,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12139,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12139,(2),null);
...
var temp__5808__auto___12169 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12169 == null)){
} else {
var key_12170 = temp__5808__auto___12169;
(jsprops.key = key_12170);
}
...
var temp__5808__auto___12171 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12171 == null)){
} else {
var key_12172 = temp__5808__auto___12171;
(jsprops.key = key_12172);
}
...
var temp__5808__auto___12174 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5808__auto___12176 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12176 == null)){
} else {
var key_12178 = temp__5808__auto___12176;
(jsprops.key = key_12178);
}
...
var temp__5808__auto___12182 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12142_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12142_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12143 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12143,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12143,(1),null);
...
break;
default:
var G__12190 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12191 = compiler;
v = G__12190;
compiler = G__12191;
continue;
...
var G__12147 = tag;
var G__12147__$1 = (((G__12147 instanceof cljs.core.Keyword))?G__12147.fqn:null);
switch (G__12147__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template12149 = (function (opts,id,fn_to_element,parse_fn,meta12150){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12149.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12151,meta12150__$1){
var self__ = this;
var _12151__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12149(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12150__$1));
}));

(reagent.impl.template.t_reagent$impl$template12149.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12151){
var self__ = this;
var _12151__$1 = this;
return self__.meta12150;
}));

(reagent.impl.template.t_reagent$impl$template12149.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12149.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12149.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12149.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12149.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12149.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12150","meta12150",1725330073,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12149.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12149.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12149");

(reagent.impl.template.t_reagent$impl$template12149.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12149");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12149.
 */
reagent.impl.template.__GT_t_reagent$impl$template12149 = (function reagent$impl$template$__GT_t_reagent$impl$template12149(opts,id,fn_to_element,parse_fn,meta12150){
return (new reagent.impl.template.t_reagent$impl$template12149(opts,id,fn_to_element,parse_fn,meta12150));
});
...
return (new reagent.impl.template.t_reagent$impl$template12149(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
